...
const ProjectsPage = () => (
  <Layout>
    ...
    <section css={style}>
      ...
      <p>I&apos;m looking for a new full-time position in Berlin or remote.</p>
      <p>Introduction</p>
      ...
      <div>
        ...
        <p>
          I have been unsing Linux as my main desktop since I was 14 years old utlizing only Open-source tools for my workflow wich made me contribute constantly over the years to Open-source, this efforts can be seen on my <Link to="/projects">projects</Link> or my Github <a href="https://github.com/dobladov/">profile</a>.
        </p>
      ...
      <div>
        ...
        <ul>
          <li>
            <b>Web Development</b> <i>NVQ Level 3</i> Doña Salvadora Muñoz
          </li>
          <li>
            <b>Computing and networks</b> <i>NVQ Level 2</i> Doña Salvadora Muñoz
          </li>
        </ul>
      </div>
    </section>
